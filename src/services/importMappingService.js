...
const columnAliases = {
  contract_number: ['cd_contrato', 'codigo_contrato', 'numero_contrato', 'n_contrato', 'contrato', 'numero', 'n'],
  ...
  object: ['objeto', 'contrato', 'object', 'descricao_objeto'],
  unit: ['unidade', 'filial', 'unidade_sesc', 'departamento', 'unit'],
  initial_value: ['vl_contrato', 'valor_inicial', 'valor_original', 'valor_contratado', 'initial_value'],
  ...
  end_date: ['validade', 'data_final', 'fim_vigencia', 'data_fim', 'vencimento', 'end_date'],
  status: ['status', 'situacao'],
  external_status: ['status_externo', 'situacao_externa', 'external_status', 'status'],
